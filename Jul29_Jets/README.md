...
4. Learn how to setup nuclear PDF. Simulate pp and AA events and then, compute the nuclear modifications to jet spectrum.
...
A faster way to download the hydro profile is using web-browser via the following link:
...
<span style="color: blue; "> Exercise 2.2: Setup XML file for "Parton Gun+ Brick Medium + MATTER (in-medium) without recoil"

<span style="color: blue; "> Exercise 2.3: Setup XML file for "Parton Gun+ Brick Medium + MATTER (in-medium) with recoil"

<span style="color: blue; "> Exercise 2.4: Setup XML file for "Parton Gun+ Brick Medium + MATTER (in-medium) without recoil + LBT"


### <span style="color: orange; ">2.2. Explore effects of models parameters  in the energy spectrum (dN/dE)  </span>

Generate 1000 events for each of the Exercieses 2.1, 2.3 and 2.4, create dN/dE spectrum as a function of energy E of the final state parton. Explore effects of alpha_s=0.1 and 0.2 and running coupling.
...
Please go to `SummerSchool2022/Jul29_Jets/analysis_scripts` directory and find `jet_reconstruction.py`.
```
cd analysis_scripts
```
